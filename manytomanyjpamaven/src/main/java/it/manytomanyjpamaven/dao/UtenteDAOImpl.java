...
public class UtenteDAOImpl implements UtenteDAO {
	...
	@Override
	public List<Utente> getEagerUtentiConRuolo(Ruolo ruoloInput) throws Exception {
		TypedQuery<Utente> query = entityManager
				.createQuery("select u from Utente u left join u.ruoli r where r = :ruolo", Utente.class);
		query.setParameter("ruolo", ruoloInput);
